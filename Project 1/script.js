...
function updateHUD() {
    questionNumElement.innerText = questions.length - availableQuestions.length + 1 + '/' + questions.length;
    scoreNumElement.innerText = score;
}

function updateProgressBar() {
    const progress = (((questions.length + 1) - availableQuestions.length) / questions.length) * 100;
